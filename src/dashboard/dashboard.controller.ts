...
export class DashboardController {
  ...
  @ApiQuery({ name: 'title', required: false, description: 'Filtro por título (case-insensitive)' })
  @ApiResponse({ status: 200, description: 'Lista de pull requests retornada com sucesso' })
